...
- Name: e2e\login\login.spec.js >> @regression @login Login flows >> TC-LOGIN-004: Malformed email does not authenticate
- Location: tests\e2e\login\login.spec.js:61:2
