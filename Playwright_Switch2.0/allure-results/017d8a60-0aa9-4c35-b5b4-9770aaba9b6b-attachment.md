...
Error: locator.setInputFiles: Error: strict mode violation: locator('input[type="file"]') resolved to 2 elements:
    ...
    2) <input title=" " type="file" id="fileUpload" accept="image/*" name="Fjb56fnotys359[UxAnzeetFdSRYz]" class="fileUpload waves-effect waves-light btn-large"/> aka getByTitle(' ', { exact: true })
      ...
      - list:
        ...
        - listitem:
          - link "NVites 71 New":
            - /url: /mnjuser/inbox
        - listitem:
          - link "Application status 42 Updates":
...
- img
- img
- text: 100% Deepak Ashokrao Jagtap
- emphasis: editOneTheme
- text: Senior Test Engineer at GlobalLogic Profile last updated - Today
- emphasis: locationOt
- text: Pune, INDIA
- emphasis: experienceOneTheme
- text: 4 Years 5 Months
...
- text: jagtapda1765@gmail.com
- emphasis: verifiedOneTheme
- emphasis: calenderOneTheme
- text: 15 Days or less notice period
- list:
...
- text: Resume QA_DeepakJ_Resume.pdf Uploaded on Jul 25, 2025 downloadOneTheme deleteOneTheme You’re 1 step away from adding your resume to your profile Continue
- img
- button "Choose File"
- button "Update resume"
- list
- text: "Supported Formats: doc, docx, rtf, pdf, upto 2 MB Resume headline editOneTheme Immediate joiner- 4 years and 3 Months of experience in automation testing In Selenium framework in java, Playwright in Typescript, REST Assured with JAVA, Postman API, K6 Load Testing, Git, Github Actions, LamdaTest Key skills editOneTheme katalon studio java selenium webdriver playwright javascript cuxumber bdd Rest Assured Ui Automation Cucumber Postman API Load Testing Employment Add employment Senior Test Engineer editOneTheme GlobalLogic Full-time Nov 2024 to Present (9 months) 15 Days or less Notice Period Position: Senior Test Engineer Company : GlobalLogic India Location: Pune Department: Quality Assurance / Testing Job Summary: I am seeking an experienced Senior Test Engineer to join our dynamic team. In this role, I will be responsible for designing, developing, and executing autom..."
- link "Read More":
  - /url: javascript:;
- text: "Top 5 key skills: Playwright, Javascript, Selenium Webdriver, Cucumber Framework, Postman API QA Engineer editOneTheme Cybage Full-time Apr 2021 to Nov 2024 (3 years 8 months) Selenium Automation QA Engineer (3.5+ years experience)- With experience in the media and marketing domains, I possess strong problem-solving abilities, adept at delivering optimal solutions. I excel as a team player, self-motivated, and a quick learner with effective communication s..."
- link "Read More":
  - /url: javascript:;
- text: Education Add education PG Diploma Computers editOneTheme SM VITA,Juhu,Mumbai. 2020-2021Full Time B.Tech/B.E. Mechanical editOneTheme SCOE,Mumbai University. 2014-2017Full Time Class XII editOneTheme Maharashtra 2011 Class X editOneTheme Maharashtra 2009 Add doctorate/PhD ;
- contentinfo:
  - link "Naukri Logo":
    - /url: https://www.naukri.com
    - img "Naukri Logo"
