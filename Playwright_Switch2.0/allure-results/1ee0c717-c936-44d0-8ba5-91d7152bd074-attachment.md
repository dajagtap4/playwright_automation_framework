...
ENOENT: no such file or directory, open 'C:\Users\deepak.jagtap\Desktop\playwright_automation_framework\Playwright_Switch2.0\state.json'
    at C:\Users\deepak.jagtap\Desktop\playwright_automation_framework\Playwright_Switch2.0\tests\APIs\demo.spec.js:17:18
```
...
- text: Email
- textbox "email@example.com": jagtapda2019@gmail.com
- text: Password
- textbox "enter your passsword": Deepak@1994
- button "Login"
...
```ts
   ...
   15 |
   16 |     await contex.storageState({path: 'state2.json'});
